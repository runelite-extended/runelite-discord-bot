  ...
  switch (command) {
    case 'help':
      const helpEmbed = createEmbed()
        ...
        .addField('!gh <query>', 'Search runelite-extended/runelite GitHub for issues and pull requests')
      ...
      break
    case 'gh':
      fetch(`https://api.github.com/search/issues?q=repo:runelite-extended/runelite+${value}`, {
        headers: {
